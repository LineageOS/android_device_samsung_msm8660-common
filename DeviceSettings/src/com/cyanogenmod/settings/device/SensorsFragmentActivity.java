...
public class SensorsFragmentActivity extends PreferenceFragment {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (key.compareTo(DeviceSettings.KEY_USE_GYRO_CALIBRATION) == 0) {
            ...
            Utils.writeValue(FILE_BLN_TOGGLE, ((CheckBoxPreference)preference).isChecked() ? "0" : "1");
        }
    ...
    public static void restore(Context context) {
        ...
        Utils.writeValue(FILE_BLN_TOGGLE, sharedPrefs.getBoolean(DeviceSettings.KEY_TOUCHKEY_BLN, true) ? "0" : "1");
    }
}
