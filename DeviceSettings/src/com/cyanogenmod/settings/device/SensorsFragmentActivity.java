...
public class SensorsFragmentActivity extends PreferenceFragment {
    ...
    public static void restore(Context context) {
        ...
        if (!sharedPrefs.getBoolean(DeviceSettings.KEY_USE_GYRO_CALIBRATION))
            Utils.writeValue(FILE_USE_GYRO_CALIB, "0");

        Utils.writeValue(FILE_TOUCHKEY_LIGHT, sharedPrefs.getBoolean(DeviceSettings.KEY_TOUCHKEY_LIGHT) ? "1" : "0");
    }
}
