...
static char *camera_fixup_getparams(int id, const char *settings)
{
    ...
    if (id == 0) {
        ...
        // preferred-preview-size-for-video parameter shows up as a ludicrous 176x144.
        // Set this instead to the native size of the screen.
        //   old overlay: ignorePreferredPreviewSizeForVideo=true
        //
        // TODO: We need a way to detect quincy so that its larger screen size can be used.
        if (params.get(android::CameraParameters::KEY_PREFERRED_PREVIEW_SIZE_FOR_VIDEO)) {
...
static char *camera_fixup_setparams(int id, const char *settings)
{
    ...
    //   old overlay: needsSamsungCamMode=true
